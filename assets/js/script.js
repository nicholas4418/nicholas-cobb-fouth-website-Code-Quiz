...
//Variable declaraction for the start button
const START_SECTION = document.getElementById("start");
const START_BTN = document.getElementById("start-button");

//Variable declaration related to Quiz section
...
//Variable Declaration for the end section
